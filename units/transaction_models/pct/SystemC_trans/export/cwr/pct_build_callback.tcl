::namespace eval ::pct::build {
  ...
  proc callback {args} {
    [namespace current]::add_vppack_path "[::subst -nobackslashes -nocommands {/workarea/GitRepo/VP_concept_examples/units/transaction_models/pct/SystemC_trans/export/parameters/HARDWARE.unevald.parameters}]" "[::subst -nobackslashes -nocommands {simulation/parameters}]"
  }
