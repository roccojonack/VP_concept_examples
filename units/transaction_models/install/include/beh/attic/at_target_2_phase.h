...
// #include "tlm_genip/tlm2_sparsemem.h"
...
/// Not implemented for this example but required by interface
  unsigned int                                      // result
  transport_dbg
  ( tlm::tlm_generic_payload  &              // debug payload
  );
...
// Member Variables ===================================================
  ...
  tlm::tlm_target_socket<64>  m_memory_socket;        ///<  target socket
  ...
  const sc_core::sc_time    m_write_response_delay; ///< write response delays
    	...
    	sc_attribute<bool> 	verification;   ///< enabler for verification
